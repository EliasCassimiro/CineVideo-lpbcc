            ...
            <form id="frmNovoEmp" name="frmNovoEmp" method="POST" action="insEmp.php">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="selEmp" id="selEmp">
                        ...
                        $consulta = mysqli_query($conexao, "SELECT *FROM ce orlientder by nome ASC");
                ...
                <!-- <div class="form-group">
                    <label for="lblCliente"><span class="badge badge-light ">Valor: </span> </label>
                    <input type="text" class="form-control"  name="valorEmp" />
                </div> -->


                <input type="submit" id="btEnviar" name="btEnviar" class="btn btn-primary" value="Gravar">
                <input type="button" id="btCancelar" name="btCancelar" class="btn btn-danger" value="Cancelar" onclick="javascript:location.href='lstEmprestimo.php'">
            </form>
        </div>
    </div>
</body>
